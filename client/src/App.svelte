<script>
  ...
  function handleTab(mode) {
    mode.currentTarget.nextElementSibling.classList.toggle("close");
  }

  function handleUpdate() {
    //.currentTarget.nextElementSibling.classList.toggle("close");
  }
...
<body>
  ...
  <div class="base">
    <div class="base-butt">
      <button class="base-tab">Tours</button>
      <button class="base-tab">Edit</button>
    </div>
    <div class="base-bar">
